			...
			if let trans = transaction as? SKPaymentTransaction
			{
				switch trans.transactionState
				{
					case .Purchased:
                        ...
                        userDefaults.setBool(true, forKey: "adsPurchased")
					...
					case .Restored:
                        ...
                        NSNotificationCenter.defaultCenter().postNotificationName("showRestoredPurchase", object: nil)
                        let userDefaults = NSUserDefaults.standardUserDefaults()
                        userDefaults.setBool(true, forKey: "adsPurchased")
                        userDefaults.synchronize()
